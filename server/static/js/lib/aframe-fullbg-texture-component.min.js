...
/***/ function(module, exports) {
	 ...
	 */
	AFRAME.registerComponent('fullbg-texture', {
	   ...
	   */
	   update: function () {
	     ...
	     var self = this;
	     if (self.dimensions) {
	       // If texture has already been loaded, and `fullbg-texture` was reset.
	       ...
	       var textureLoaded = function(e) {
	          ...
	          // Save dimensions for later updates to `fullbg-texture-texture`, see above.
